...
<Properties>
  <View=-74,38,1166,1067,0.683014,0,0>
  <Grid=10,10,1>
...
<Components>
  ...
  <.SP SP1 1 20 350 0 79 0 0 "log" 1 "1MHz" 1 "100MHz" 1 "1001" 1 "no" 0 "1" 0 "2" 0 "no" 0 "no" 0>
  <Eqn Eqn1 1 200 370 -28 15 0 0 "dBS21=dB(S[2,1])" 1 "dBS11=dB(S[1,1])" 1 "yes" 0>
  <.DC DC1 1 600 350 0 47 0 0 "26.85" 0 "0.001" 0 "1 pA" 0 "1 uV" 0 "no" 0 "150" 0 "no" 0 "none" 0 "CroutLU" 0>
  <Sub Balun1 1 220 150 -10 34 0 0 "IdealBalun.sch" 0>
  <GND * 5 190 190 0 0 0 0>
  <GND * 5 100 210 0 0 0 0>
  <Vdc V1 1 100 160 18 -26 0 1 "1V" 1>
</Components>
<Wires>
  ...
  <280 90 330 90 "" 0 0 0 "">
  <280 260 330 260 "" 0 0 0 "">
  <280 170 280 260 "" 0 0 0 "">
  <-20 90 -20 160 "" 0 0 0 "">
  <-20 90 190 90 "" 0 0 0 "">
  <190 170 190 190 "" 0 0 0 "">
  <100 130 190 130 "" 0 0 0 "">
  <100 190 100 210 "" 0 0 0 "">
</Wires>
<Diagrams>
  <Rect 280 794 549 284 3 #c0c0c0 1 00 0 0 5e+06 3.5e+07 0 -50 5 5 1 -1 0.5 1 315 0 225 "" "" "" "">
	<"dBS11" #0000ff 0 3 0 0 0>
	<"dBS21" #ff0000 0 3 0 0 0>
	  <Mkr 1.01391e+07 198 -353 3 0 0>
  </Rect>
</Diagrams>
<Paintings>
