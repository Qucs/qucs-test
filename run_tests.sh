...
python3 run.py --prefix ${QUCS_HOME}/bin/ --exclude skip.txt --qucs --reset -mp ${NO_CORES}
#python3 run.py --prefix ${QUCS_HOME}/bin/ --exclude skip.txt --qucsator --reset -mp ${NO_CORES}
